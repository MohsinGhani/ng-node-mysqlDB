...
export class AddCollectorComponent implements OnInit {
  ...
  dummyData = [
    { name: 'Mohsin Ghani', email: '', address: 'PECHS', salary: '10000', qualification: ['Master of Clinical Medicine (MCM)'], dob: '1997-01-21', age: '21', contact: '03432195645', gender: 'male', branchName: 'DHA', password: '123456', post:'collector', status: 1}
  ];
